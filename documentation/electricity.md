...
### 3.2.7	Trial Credit Vend Happy Path 
...
### 3.3 Credit Vend Use Case

#### 3.3.1 Credit Vend Description
The credit vend token use case is used to purchase prepaid electricity credit tokens.

#### 3.3.2 Credit Vend Desired Outcome
The customer pays for and receives the purchased credit token.

#### 3.3.3 Credit Vend Preconditions
- The meter number shall be supplied.
- The sale amount shall be supplied.

#### 3.3.4 Credit Vend Participants
- The customer
- The Vendor/Merchant
- PrepaidPlus Server
- Service Provider’s Electricity vending server

#### 3.3.5 Credit Vend Workflow
The workflow for the Credit Vend process is as presented below in Table 3.3.

**Table 3.3: Credit Vend Workflow**
...
The sale is confirmed in both systems, unless there is an error that warrants a “Last Response” call. Refer to Section 3.4 below for last response call.

#### 3.3.6 Credit Vend Happy Path
...
### 3.4 Last Response Use Case

#### 3.4.1 Last Response Description
...
#### 3.4.2 Last Response Desired Outcome
...
#### 7.1 Prepaid Electricity Methods

**Table 6.1: Supported Prepaid Electricity Methods**
...
**Table 6.2: Trial Credit Vend call requirements**
...
**Table 6.4: Trial Credit Vend Errors**
...
**Table 6.5: Trial Credit Vend Response**
...
**Table 6.7: Credit Vend Request requirements**
...
**Table 6.8: Credit Vend Request Errors**
...
**Table 6.9: Credit Vend Response**
...
**Table 6.11: Last Response call requirements**
...
**Table 6.12: Last Response Request Errors**
...
**Table 6.13: Last Response Response parameters**
